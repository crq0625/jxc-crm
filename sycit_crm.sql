...
Source Database       : sycit_jiajun

Target Server Type    : MYSQL
Target Server Version : 50716
File Encoding         : 65001

Date: 2018-03-18 21:29:11
*/
...
CREATE TABLE `syc_auth_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='AUTH用户组表';
...
CREATE TABLE `syc_finance_schedule` (
  ...
  PRIMARY KEY (`fsid`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='收款附表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='物流信息表';
...
CREATE TABLE `syc_purchase` (
  ...
  `pstart_date` date NOT NULL DEFAULT '0000-00-00' COMMENT '销售日期',
  `pend_date` date NOT NULL DEFAULT '0000-00-00' COMMENT '发货日期',
  `create_time` int(16) NOT NULL DEFAULT '0' COMMENT '添加时间',
  `update_time` int(16) NOT NULL DEFAULT '0' COMMENT '更新时间',
...
-- ----------------------------
INSERT INTO `syc_users` VALUES ('1', 'asdasd', 'sha256:1000:X2vbzkCcKSScvZZ5ZUDs7DvTmergIc5u:fQt8UQynrp5psap5MoOq4scNMLNhcjIl', '隐士', '1', '1', 'hyzwd@outlook.com', '/uploads/avatar/582d3a26a3369.jpg', '2017-01-01', '152', '1451577600', '1497704499', '127.0.0.1', '127.0.0.1', '1');